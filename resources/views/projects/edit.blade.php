                        ...
                        <form action="{{ route('projects.update', $project) }}" method="POST">
                            ...
                            <div class="form-group margin-bottom-20">
                                ...
                                <select name="type" id="type" class="form-control @error('type') is-invalid @enderror" required>
                                    <option value="new_development" {{ old('type', $project->type) == 'new_development' ? 'selected' : '' }}>🚀 New Development (Fresh Project)</option>
                                    <option value="maintenance" {{ old('type', $project->type) == 'maintenance' ? 'selected' : '' }}>🔧 Maintenance Project (Ongoing Support / Live App)</option>
                                </select>
                            ...
                            <div class="form-group margin-bottom-20">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" name="url" id="url" class="form-control @error('url') is-invalid @enderror" placeholder="https://example.com or https://github.com/org/repo" value="{{ old('url', $project->url) }}">
                                </div>
